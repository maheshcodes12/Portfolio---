...
export default function ProjectsPage() {
 ...
 equivalence checking at the assembly level.'
					technologies={["GPU Kernel Verification"," CUDA/PTX Analysis"," Symbolic Execution"," Correctness", "Formal Equivalence Checking", "High Performance Computing", "SMT Solver (Z3)"]}
					link=''
					link2={""}
					imageUrl='/projects/img-PTX-project.png'
				/>
				<ProjectShowcase
 ...
 form, and then formally verifies the transformation using SMT solvers.'
					technologies={["AI for Compilers","LLM-based Code Optimization"," LLM-based Code Generation", "Compiler Optimization", "Loop Vectorization", "Performance","Correctness", "Formal Verification", "SMT Solvers (Z3)", "AVX2, x86"]}
					link={""}
 ...
 backends.'
					technologies={["AI Compilers", "Compilers for AI", "Python-based DSL, MLIR", "LLVM IR", "Loop Scheduling Optimizations", "High Performance Computing", "Heterogeneous Computing"]}
				...
				<ProjectShowcase
					...
					technologies={["Compiler Optimizations", "Peephole Optimizations", "Static Analysis", "LLVM",  "LLVM IR", "Superoptimization", "Compiler Testing","Precision", "Compiler Verification", "Semantics", "Formal Equivalence Checking", "SMT Solvers", "Soundness", "Pattern Matching", "WebAssembly", "JIT Compiler", "Cranelift"]}
				...
				<ProjectShowcase
					...
					technologies={["LLVM Static Analysis", "SMT Solvers", "Compiler Testing", "LLVM", "Precision", "Soundness", "Formal Methods"]}
				...
				<ProjectShowcase
					...
					LLVM.'
					technologies={["Superoptimization", "LLVM IR", "Peephole Optimizations", "Semantics", "SMT Solvers", "Formal Verification", "Compiler Automation"]}
				...
				<ProjectShowcase
					...
					technologies={["PeepHole Optimization", "JIT Compiler", "WebAssembly", "Pattern Matching", "Code Generation", "Compiler Automation"]}
